...
const Info = () => {
  ...
  <List>
    ...
    <List.Item>
      ...
      <Text>
        Highlighting makes matching easier. Additionally, a rule cannot be 
        applied incorrectly. However, you can still choose the wrong rule!
      </Text>
    </List.Item>
    <List.Item>
      <Text fw={700}>Checking</Text>
      <Text>
        You can always check if the current proof tree is still solvable!
      </Text>
    </List.Item>
  </List>
  ...
  <Text>
    If you find errors or have great ideas, you have two options: You can 
    either open an issue on GitHub or fix it yourself and submit a pull 
    request.
  </Text>
  ...
  <Text>
    This is not official software for the FMFP course at ETHZ. There are no
